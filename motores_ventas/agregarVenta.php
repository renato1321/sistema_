	...
	if(isset($_POST['client_id'])){
		if(isset($_POST['article_id'])){
			if(isset($_POST['cant_articles'])){
				$query = sprintf("INSERT INTO ventas(cliente_id, articulo_id,	cantidad_de_articulos) VALUES('%s', '%s', '%s');", mysqli_real_escape_string($con, $_POST['client_id']),
						mysqli_real_escape_string($con, $_POST['article_id']),
						mysqli_real_escape_string($con, $_POST['cant_articles']));
